...
/**
 *  The certificate is authenticated by CredentialValidator, for example, the password certificate uses login authentication, in this example, phone OTP authentication is used
 */
